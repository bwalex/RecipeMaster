...
<body>
	...
	*/
	...
	<div class="highslide-gallery" style="clear: both;">
	    ...
	    <ul>
		<li><a href="highslide/sample-images/thumbstrip01.jpg" class="highslide" title="Caption from the anchor's title attribute" onclick="return hs.expand(this, config1 )"><img src="highslide/sample-images/thumbstrip01.thumb.jpg" alt=""></a></li>

		<li><a href="highslide/sample-images/thumbstrip02.jpg" class="highslide" title="Caption from the anchor's title attribute" onclick="return hs.expand(this, config1 )"><img src="highslide/sample-images/thumbstrip02.thumb.jpg" alt=""></a></li>

		<li><a href="highslide/sample-images/thumbstrip12.jpg" class="highslide" title="Caption from the anchor's title attribute" onclick="return hs.expand(this, config1 )"><img src="highslide/sample-images/thumbstrip12.thumb.jpg" alt=""></a></li>

		<li><a href="highslide/sample-images/thumbstrip07.jpg" class="highslide" title="Caption from the anchor's title attribute" onclick="return hs.expand(this, config1 )"><img src="highslide/sample-images/thumbstrip07.thumb.jpg" alt=""></a></li>

		<li><a href="highslide/sample-images/thumbstrip22.jpg" class="highslide" title="Caption from the anchor's title attribute" onclick="return hs.expand(this, config1 )"><img src="highslide/sample-images/thumbstrip22.thumb.jpg" alt=""></a></li>

		<li><a href="highslide/sample-images/thumbstrip24.jpg" class="highslide" title="Caption from the anchor's title attribute" onclick="return hs.expand(this, config1 )"><img src="highslide/sample-images/thumbstrip24.thumb.jpg" alt=""></a></li>

		<li><a href="highslide/sample-images/thumbstrip03.jpg" class="highslide" title="Caption from the anchor's title attribute" onclick="return hs.expand(this, config1 )"><img src="highslide/sample-images/thumbstrip03.thumb.jpg" alt=""></a></li>

		<li><a href="highslide/sample-images/thumbstrip05.jpg" class="highslide" title="Caption from the anchor's title attribute" onclick="return hs.expand(this, config1 )"><img src="highslide/sample-images/thumbstrip05.thumb.jpg" alt=""></a></li>

		<li><a href="highslide/sample-images/thumbstrip06.jpg" class="highslide" title="Caption from the anchor's title attribute" onclick="return hs.expand(this, config1 )"><img src="highslide/sample-images/thumbstrip06.thumb.jpg" alt=""></a></li>

		<li><a href="highslide/sample-images/thumbstrip08.jpg" class="highslide" title="Caption from the anchor's title attribute" onclick="return hs.expand(this, config1 )"><img src="highslide/sample-images/thumbstrip08.thumb.jpg" alt=""></a></li>
	    </ul>

	    <div style="clear:both"></div>
	</div><a name="detailednutri" id="detailednutri">.</a>
